...
class PolisController extends Controller
{
    ...
    public function popupNomenListAction(Request $request){
        ...
        $nomenList = $polisService ->getNomenList($this->getUser());
        ...
        return $this->render('polis/popup_nomen_list.html.twig', array(
            'user' => $this->getUser(),
            'base_dir' => realpath($this->container->getParameter('kernel.root_dir').'/..'),
            'page_title' => $page_title,
            'breadcrumb' => $breadcrumb,
    ...
    public function popupProdListAction(Request $request){
        ...
        $prodList = $polisService ->getProdList($this->getUser());
        ...
        return $this->render('polis/popup_prod_list.html.twig', array(
            'user' => $this->getUser(),
            'base_dir' => realpath($this->container->getParameter('kernel.root_dir').'/..'),
            'page_title' => $page_title,
            'breadcrumb' => $breadcrumb,
